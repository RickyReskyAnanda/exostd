...
<!-- Mirrored from bootstrapmade.com/demo/themes/Butterfly/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 May 2017 13:30:35 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, maximum-scale=1">
<title>Exomatik Studio</title>
<link rel="icon" href="favicon.png" type="image/png">
<link href="<?=base_url()?>assets/css/bootstrap.css" rel="stylesheet" type="text/css">
<link href="<?=base_url()?>assets/css/style.css" rel="stylesheet" type="text/css">
<link href="<?=base_url()?>assets/css/linecons.css" rel="stylesheet" type="text/css">
...
<header id="header_outer">
  <div class="container">
    <div class="header_section">
      <div class="logo"><a href="javascript:void(0)"><img src="<?=base_url()?>assets/img/logob.png" alt=""></a></div>
      <nav class="nav" id="nav">
        <ul class="toggle">
          <li><a href="#top_content">Beranda</a></li>
          <li><a href="#service">Pelayanan</a></li>
          <li><a href="#work_outer">Pekerja</a></li>
          <li><a href="#Portfolio">Portofolio</a></li>
          <li><a href="#client_outer">Pemesan</a></li>
        ...
        <div class="row">
          <div class="col-lg-5 col-sm-7">
            <div class="top_left_cont flipInY wow animated">
              <h3>Aplikasi &amp; Desain!</h3>
              <h2>Exomatik Studio
                Memberikan Hasil Terbaik</h2>
              <p> Point terpenting adalah kenyamanan dalam penggunaan serta kreatifitas diatas kebutuhan </p>
              <a href="#service" class="learn_more2">Lebih Lengkap</a> </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">Pembuatan Web</h3>
            <p class="animated fadeInDown wow">Proin iaculis purus consequat sem cure digni. Donec porttitora entum suscipit  aenean rhoncus posuere odio in tincidunt.</p>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">Desain Grafis</h3>
            <p class="animated fadeInDown wow">Proin iaculis purus consequat sem cure digni. Donec porttitora entum suscipit  aenean rhoncus posuere odio in tincidunt.</p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-sm-6 wow fadeInLeft delay-05s">
          ...
          <div class="service-list">
            ...
            <div class="service-list-col2">
              <h3>Testing & Konfirmasi</h3>
              <p>Proin iaculis purus consequat sem digni ssim. Sem porttitora entum.</p>
            </div>
          </div>
          <div class="work_bottom"> <span>Daftar atau Hubungi Kami</span> <a href="#contact" class="contact_btn">Kontak</a> </div>
        </div>
        <figure class="col-lg-6 col-sm-6  text-right wow fadeInUp delay-02s"> </figure>
      </div>
    </div>
  </div>
  <!--<div class="work_pic"><img src="<?=base_url()?>assets/img/dashboard_pic.png" alt=""></div>-->
  </div>
</section>
<!--main-section-end--> 
  ...
  <div class="portfolio"> 
    ...
    <div class="isotope" style="position: relative; overflow: hidden; height: 480px;" id="portfolio-wrap"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   videography isotope-item">
        <div class="portfolio-image"> <img src="<?=base_url()?>assets/img/portfolio_pic1.jpg"  alt="Portfolio 1"> </div>
        <a title="Starbucks Coffee" rel="prettyPhoto[galname]" href="../../../../clapat.ro/themes/newave/images/portfolio/portfolio2.jpg">
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio-image"> <img src="<?=base_url()?>assets/img/portfolio_pic2.jpg" alt="Portfolio 1"> </div>
        <div class="project-overlay">
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design  isotope-item">
        <div class="portfolio-image"> <img src="<?=base_url()?>assets/img/portfolio_pic3.jpg" alt="Portfolio 1"> </div>
        <div class="project-overlay">
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  photography  branding web isotope-item">
        <div class="portfolio-image"> <img src="<?=base_url()?>assets/img/portfolio_pic4.jpg" alt="Portfolio 1"> </div>
        <div class="project-overlay">
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio-image"> <img src="<?=base_url()?>assets/img/portfolio_pic5.jpg" alt="Portfolio 1"> </div>
        <div class="project-overlay">
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  web isotope-item">
        <div class="portfolio-image"> <img src="<?=base_url()?>assets/img/portfolio_pic6.jpg" alt="Portfolio 1"> </div>
        <div class="project-overlay">
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design web isotope-item">
        <div class="portfolio-image"> <img src="<?=base_url()?>assets/img/portfolio_pic7.jpg" alt="Portfolio 1"> </div>
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   photography isotope-item">
        <div class="portfolio-image"> <img src="<?=base_url()?>assets/img/portfolio_pic8.jpg" alt="Portfolio 1"> </div>
        <a title="Stereo Headphones" rel="prettyPhoto[galname]" href="../../../../clapat.ro/themes/newave/images/portfolio/portfolio8.jpg">
        <div class="project-overlay">
          <div class="project-info">
            <div class="zoom-icon"></div>
  ...
  <div class="client_area ">
    <div class="client_section animated  fadeInUp wow">
      <div class="client_profile">
        <div class="client_profile_pic"><img src="<?=base_url()?>assets/img/client-pic1.jpg" alt=""></div>
        <h3>Ahmad Jayadi Laga</h3>
        <span>Lawless Inc</span> </div>
      <div class="quote_section">
        <div class="quote_arrow"></div>
        <p><b><img src="<?=base_url()?>assets/img/quote_sign_left.png" alt=""></b> Proin iaculis purus consequat sem cure  digni ssim donec porttitora entum suscipit rhoncus. Accusantium quam, ultricies eget id, aliquam eget nibh et. Maecen aliquam, risus at semper. <small><img src="<?=base_url()?>assets/img/quote_sign_right.png" alt=""></small> </p>
      </div>
      <div class="clear"></div>
    </div>
    <div class="client_section animated  fadeInDown wow">
      <div class="client_profile flt">
        <div class="client_profile_pic"><img src="<?=base_url()?>assets/img/client-pic2.jpg" alt=""></div>
        <h3>Pemkot Makassar</h3>
...
<div class="c-logo-part"><!--c-logo-part-start-->
  <div class="container">
    <ul class="delay-06s animated  bounce wow">
      <li><a href="javascript:void(0)"><img src="<?=base_url()?>assets/img/c-liogo1.png" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="<?=base_url()?>assets/img/c-liogo2.png" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="<?=base_url()?>assets/img/c-liogo3.png" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="<?=base_url()?>assets/img/c-liogo5.png" alt=""></a></li>
    </ul>
  </div>
</div>
<!--c-logo-part-end-->
    ...
    <div class="team-leader-block clearfix">
      <div class="team-leader-box">
        <div class="team-leader wow fadeInDown delay-03s">
          ...
          <img src="<?=base_url()?>assets/img/team-leader-pic1.jpg" alt="">
          <ul>
      ...
      <div class="team-leader-box">
        <div class="team-leader  wow fadeInDown delay-06s">
          <div class="team-leader-shadow"><a href="javascript:void(0)"></a></div>
          <img src="<?=base_url()?>assets/img/team-leader-pic2.jpg" alt="">
          <ul>
            <li><a href="javascript:void(0)" class="fa-twitter"></a></li>
            <li><a href="javascript:void(0)" class="fa-facebook"></a></li>
            <li><a href="javascript:void(0)" class="fa-pinterest"></a></li>
      ...
      <div class="team-leader-box">
        <div class="team-leader wow fadeInDown delay-09s">
          <div class="team-leader-shadow"><a href="javascript:void(0)"></a></div>
          <img src="<?=base_url()?>assets/img/team-leader-pic3.jpg" alt="">
          <ul>
            <li><a href="javascript:void(0)" class="fa-twitter"></a></li>
            <li><a href="javascript:void(0)" class="fa-facebook"></a></li>
            <li><a href="javascript:void(0)" class="fa-pinterest"></a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="contact_block">
              ...
              <span> <a href="mailto:hello@butterfly.com"> studio@exomatik.com</a> </span> </div>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-lg-6 wow fadeInUp delay-06s">
          <div class="form">
                ...
                <form action="#" method="post" role="form" class="contactForm">
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control input-text" name="email" id="email" placeholder="Your Email" data-rule="email" data-msg="Masukkan email valid" />
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                  ...
                  <button type="submit" class="btn input-btn">Kirim</button>
                </form>
          </div>
        </div>
      </div>
